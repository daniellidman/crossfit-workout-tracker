export default function StolenSidebar() {
  return (
    <div class="shadow-blue-gray-900/5 relative flex h-[calc(100vh-20rem)] w-full max-w-[20rem] flex-col rounded-xl bg-white bg-clip-border p-4 text-gray-700 shadow-xl">
      <div class="mb-2 p-4">
      ...
      <nav class="text-blue-gray-700 flex min-w-[240px] flex-col gap-1 p-2 font-sans text-base font-normal">
        ...
        >
          ...
          <div class="ml-auto grid place-items-center justify-self-end">
            <div class="bg-blue-gray-500/20 text-blue-gray-900 relative grid select-none items-center whitespace-nowrap rounded-full px-2 py-1 font-sans text-xs font-bold uppercase">
              <span class="">14</span>
            </div>
          </div>
        </div>
